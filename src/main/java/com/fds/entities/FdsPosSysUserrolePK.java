 ...
 */
@Embeddable
public class FdsPosSysUserrolePK implements Serializable {
	...
	public FdsPosSysUserrolePK() {
	}
	
	public FdsPosSysUserrolePK(String iduser, long idrole) {	
		this.iduser = iduser;
		this.idrole = idrole;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FdsPosSysUserrolePK)) {
			return false;
		}
		FdsPosSysUserrolePK castOther = (FdsPosSysUserrolePK)other;
		return 
