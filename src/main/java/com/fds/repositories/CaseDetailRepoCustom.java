...
public interface CaseDetailRepoCustom {
	public Page<FdsPosCasesDetail> searchCase(String query, String fromdate, String todate);
	public Page<FdsPosCasesDetail> searchCasePos(String query, String fromdate, String todate);
