...
public class TimeConverter {
	...
	/**
	 * Convert Date => <code>yyyyMMdd</code> hoac
	 * <code>yyyyMMdd</code> cho
	 * muc dich tim kiem. <br>
	 * ismax = true se return chuoi <code>yyyyMMdd</code> nguoc
	 * lai <code>yyyyMMdd</code>
	 * 
	 * @param date
	 *            Date
	 * @param ismax
	 ...
	 * @return String
	 */
	public String convertDate(final Date date, final boolean ismax) {
		if (date != null) {
			final Calendar cal = Calendar.getInstance();
			cal.setTime(date);
			final int iYyear = cal.get(Calendar.YEAR);
