...
@SpringComponent
@ViewScope
public class ProcessDifference extends CustomComponent implements ReloadAutoComponent {
	private static final long serialVersionUID = 8808990975324145765L;
	public static final String CAPTION = "XỬ LÝ KHÁC";
	private final static String STATUS = "DIF";
