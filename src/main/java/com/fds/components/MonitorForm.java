...
import com.fds.components.DiscardForm.Callback;
...
@SpringComponent
@Scope("prototype")
public class MonitorForm extends VerticalLayout {
	private static final long serialVersionUID = 1L;

	private static final String STATUS = "MON";

	private static final Logger LOGGER = LoggerFactory.getLogger(DiscardForm.class);

	public MonitorForm(final Callback callback, final String caseno, final String cardnumber, final ArrayList<String> arCaseNo) {
		super();
		...
		caseStatUpdateComp.txtareaComment.setVisible(true);
