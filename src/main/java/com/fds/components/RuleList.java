...
public class RuleList extends HorizontalLayout {
	...
	public RuleList() {
		...
		grid.setSizeFull();
		BeanItemContainer<FdsPosRule> beanItemContainer = new BeanItemContainer<FdsPosRule>(FdsPosRule.class, ruleService.findAll());
		...
		grid.addSelectionListener(evt -> {
			if (grid.getSelectedRow() != null) {
				FdsPosRule fdsRuleList = (FdsPosRule) grid.getSelectedRow();
