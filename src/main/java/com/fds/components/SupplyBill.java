...
public class SupplyBill extends CustomComponent implements ReloadAutoComponent {
	private static final long serialVersionUID = 8808990975324145765L;
	public static final String CAPTION = "CUNG CẤP CHỨNG TỪ";
	private final static String STATUS = "BIL";
