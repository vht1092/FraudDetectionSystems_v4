...
//				"<div style=\"background-color: #0072c6;\">" + "<img class=\"v-icon\" src=\"/VAADIN/themes/mytheme/img/logo.png\"></img>"				+ " <span style=\"font-size:24px; color:#ffffff;font-weight: bold;text-transform: uppercase;\">Fraud Detection System</span></div>");
		final Label lbHeader = new Label(
				"<div style=\"background-color: #1c24ac;\">" + "<img class=\"v-icon\" src=\"" + urlServer + "/VAADIN/themes/mytheme/img/logo_new.png\" style='width: 237px;height: 105px;'></img>"				+ " <span style=\"font-size:24px; color:#ffffff;font-weight: bold;text-transform: uppercase;\">Fraud Detection System</span></div>");
