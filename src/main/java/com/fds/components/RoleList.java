...
public class RoleList extends CustomComponent {
	...
	private BeanItemContainer<FdsPosSysRole> beanRoleContainer;
	private BeanItemContainer<FdsPosSysTxn> beanScreenContainer;
	//private FormLayout formLayout;
	//private Button btSave;
	//private Grid gridRole;
	private FdsPosSysRole fdsSysRole;
	...
	public RoleList() {
		...
		beanRoleContainer = new BeanItemContainer<FdsPosSysRole>(FdsPosSysRole.class);
		beanScreenContainer = new BeanItemContainer<FdsPosSysTxn>(FdsPosSysTxn.class);
		beanScreenContainer.addAll(sysTxnService.findAll());
		// Form for editing the bean
		final BeanFieldGroup<FdsPosSysRole> binder = new BeanFieldGroup<FdsPosSysRole>(FdsPosSysRole.class);
		...
		return new CommitHandler() {
			...
			public void postCommit(CommitEvent commitEvent) throws CommitException {
				...
				for (Object a : listSelected) {
					BeanItem<FdsPosSysTxn> beanScreenItem = beanScreenContainer.getItem(a);
